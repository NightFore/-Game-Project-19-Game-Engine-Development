menu_config = {
    ...
    'main_menu': {
        ...
        "label": {
            'header': {
                'pos_x': 250, 'pos_y': 20, 'rect_width': 300, 'rect_height': 25,
    ...
    'test_menu': {
        "button": {
            ...
            'quit_game': {
                'pos_x': 100, 'pos_y': 400, 'rect_width': 64, 'rect_height': 64,
        ...
        "label": {
            'test_header': {
                'pos_x': 250, 'pos_y': 50, 'rect_width': 300, 'rect_height': 100,
